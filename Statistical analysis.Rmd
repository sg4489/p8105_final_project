...
In the test above, we observed a significant difference in mortality rates between 2019 and 2021. What, then, caused this difference? As we know, the COVID-19 pandemic unfolded between 2019 (pre-pandemic) and 2021 (pandemic peak). As shown in the plot below, the trend of COVID-19-related deaths closely mirrors the trends of both total deaths and natural deaths. 
...
Since the variable is not normally distributed, we used a Wilcoxon Rank-Sum Test.
